...
const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { action: "Toggle visibility (creator)", how: "Room settings → Public/Private toggle (lobby listing changes instantly)" },
      { action: "Manage tags (creator)", how: "Add or remove topic tags from room settings (public rooms only)" },
